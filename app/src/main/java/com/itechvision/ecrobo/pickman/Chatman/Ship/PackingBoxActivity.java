...
public class PackingBoxActivity extends BaseActivity implements View.OnClickListener, MainAsynListener {
    ...
    String TAG = "PackingBoxActivity";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_packing_box);
        ButterKnife.bind(PackingBoxActivity.this);
        Intent i = getIntent();
        Log.d(TAG,"On Create ");
...
//        mPackingList = NewPickingActivity.packData;
...
//                        .add(R.id.pck_4, "box-" + map.get("boxNo")));
    ...
    void createList(){
        ...
        for(Map<String,String> map1 : NewPickingActivity.packData){
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("はい", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        PackingBoxActivity.this.setResult(Activity.RESULT_OK, i);
                        finish();
//                                addBox();
                        dialog.cancel();
    ...
    @OnClick(R.id.packing_close_btn) void closeBtn(){
        ...
        PackingBoxActivity.this.setResult(Activity.RESULT_CANCELED, i);
        finish();
    }
    @OnClick (R.id.btn_finishBox) void finishBox (){
        Log.d("BTN", "Finish Button");
        new AlertDialog.Builder(PackingBoxActivity.this)
                .setTitle("Finish?")
                .setPositiveButton("はい", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        if (FixedPicking.empty==1) {
                            ...
                            PackingBoxActivity.this.setResult(Activity.RESULT_OK, i);
                            finish();
                        } else U.beepError(PackingBoxActivity.this, "There is something remaining, Please clear and do again");
                    }
                })
                .setNegativeButton("いいえ", new DialogInterface.OnClickListener() {
                    @Override
