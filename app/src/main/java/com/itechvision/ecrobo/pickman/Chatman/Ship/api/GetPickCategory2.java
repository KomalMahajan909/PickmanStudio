...
//        NewShipActivity.count=0;
        final IncludeShippingActivity act = (IncludeShippingActivity) activity;
...
//                map1.put("BoxID",ShippingActivity.mBoxNo+"");
    ...
    public void valid(String code, String message, JsonArray list,
        ...
        ((IncludeShippingActivity) activity).setProc(IncludeShippingActivity.PROC_BARCODE);
    }
