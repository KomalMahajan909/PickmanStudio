...
/**
 * Created by lenovo on 3/27/2019.
 */

public class BoxNumberDetail {

    String TAG = "BoxNumberDetail";

    public void post(String code, String message, JsonArray list, HashMap<String, String> params, Activity activity) {

        List<Map<String, String>> data = new ArrayList<Map<String, String>>();

        final BoxSizeActivity act = (BoxSizeActivity) activity;
        String name = null;
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (list2 != null) {
                for (int j = 0; j < list2.size(); j++) {
                    ...
                    map.put("date_time",row2.getStringOrNull("date_time"));
                    data.add(map);
                }
            }
        }
