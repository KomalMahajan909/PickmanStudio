...
public class FixedPickCategory2
{
        ...
        if (list.size() > 0) {
            ...
            if (act.mNextBarcode) {
                ...
                if(IncludeShippingActivity.inspectionNo == 1)
                    ...
                    act.removeData(IncludeShippingActivity.inspectionNo);

            }

            else if (!row.containsKey("data")){
                ShippingActivity.includenotinspected = all_row_count;
                Log.e(TAG,"111111111111     "+ShippingActivity.includenotinspected);
                ...
                if(Integer.parseInt(ShippingActivity.includenotinspected)==0){
                    if(BaseActivity.getBoxNo()){
                        ...
                        act.setProc(IncludeShippingActivity.PROC_BOX);
