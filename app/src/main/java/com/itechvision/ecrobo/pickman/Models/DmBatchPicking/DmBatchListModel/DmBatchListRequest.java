...
public class DmBatchListRequest {
    ...
    public DmBatchListRequest(String admin_id, String authId, String shop_id, String app_version, String create_date, String status, String batch_remarks) {
