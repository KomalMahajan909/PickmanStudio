...
public class DmBatchBoxActivity extends BaseActivity implements DataManager.DmGetboxBatchcall, DataManager.DmBoxBatchSumbitcall {
    ...
    DataManager.DmGetboxBatchcall getboxBatchcall;
    DataManager.DmBoxBatchSumbitcall boxBatchSumbitcall;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_dm_batch_box);
...
//        submitcall = this;
        ...
        if(invoice_status.equalsIgnoreCase("2")){
            Intent i = new Intent(DmBatchBoxActivity.this, DmBatchPickingActivity.class);
...
//        super.onBackPressed();
    ...
    void onboxsubmitClick() {
        ...
        progress.Show();
        DmBoxBatchSubmitReq req = new DmBoxBatchSubmitReq(adminid, authid, BaseActivity.getShopId(), batchid, OrderID, getResources().getString(R.string.version), date, _gts(R.id.scanbarcode));
        manager.DmBoxBatchSubmit(req, boxBatchSumbitcall);
    }
    ...
    public void inputedEvent(String buff, boolean isScaned) {
        switch (mProcNo) {
            ...
            case PROC_ORDERID:
                ...
                progress.Show();
                DmBoxBatchRequest req = new DmBoxBatchRequest(adminid, authid, BaseActivity.getShopId(), batchid, orderId.getText().toString(), getResources().getString(R.string.version), date, "");
                manager.DmGetboxBatch(req, getboxBatchcall);
                break;
            ...
            case PROC_ORDERNO:
                ...
                progress.Show();
                DmBoxBatchRequest req1 = new DmBoxBatchRequest(adminid, authid, BaseActivity.getShopId(), batchid, order1, getResources().getString(R.string.version), date, "orderno");
                manager.DmGetboxBatch(req1, getboxBatchcall);
            ...
            case PROC_TRACKID:
                ...
                progress.Show();
                DmBoxBatchRequest req2 = new DmBoxBatchRequest(adminid, authid, BaseActivity.getShopId(), batchid, track, getResources().getString(R.string.version), date, "mediacode");
                manager.DmGetboxBatch(req2, getboxBatchcall);
        ...
        if (message.getCode().equalsIgnoreCase("0")){
            ...
            new android.app.AlertDialog.Builder(this, R.style.DialogThemee)
                    ...
                    .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent in = new Intent(DmBatchBoxActivity.this, LoginActivity.class);
                            startActivity(in);
                            finish();
                        }
                    })
...
*/
    @Override
    public void onSucess(int status, DmBoxBatchResponse message) throws JsonIOException {
        progress.Dismiss();
        if (message.getCode().equals("200")) {
    ...
    @Override
    public void onSucess(int status, DmBoxBatchSubmitResponse message) throws JsonIOException {
        progress.Dismiss();
