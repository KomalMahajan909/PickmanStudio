...
public class AdapBatch_rav extends RecyclerView.Adapter<AdapBatch_rav.ViewHolder> {
    int flag = 0, ePos;
    ViewHolder view;
    ...
    public AdapBatch_rav(Context context, ArrayList<BatchpickResponse_result> arrstate, onClickCallback onclick) {
