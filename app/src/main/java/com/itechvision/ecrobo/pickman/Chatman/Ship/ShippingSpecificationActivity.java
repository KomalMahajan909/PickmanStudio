...
import com.itechvision.ecrobo.pickman.Chatman.Ship.api.CheckSpecification;
import com.itechvision.ecrobo.pickman.Chatman.Ship.api.GetSpecification;
import com.itechvision.ecrobo.pickman.Chatman.Stock.SlipPrinterActivity;
import com.itechvision.ecrobo.pickman.Chatman.Stock.api.CheckSpecificationnew;
...
public class ShippingSpecificationActivity extends BaseActivity implements View.OnClickListener, MainAsynListener, BoxSelectAdapter.ItemClickListener{
    ...
    public static final int REQ_TRACK_CHECK = 4;
    public static final int REQ_QTY = 3;
    String orderId = "", action = "",company ="",SlipPrinterScreen="";
    String TAG= ShippingSpecificationActivity.class.getSimpleName();
    ArrayList<String> sizes= new ArrayList<>();
    String arrsize[] = {"デフォルトサイズを選択","60","80","100","120","140","160","200","1","2","2.5","3","null"};
    public  static String BatchStatus ="";

    BoxSelectAdapter adapter;
    BoxSelectAdapter.ItemClickListener itemClickListener;
    public static String arrBox[]={"70", "90", "130","170","180","190", "220","240","260","270","280","290","300"};
    BottomSheetDialog boxBottom;
    // microsoft
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(ShippingSpecificationActivity.this);
        ...
        if(trackfix.equals("0") ||trackfix.equals("") ){
            ...
            SharedPrefrences.set_trackCheck(ShippingSpecificationActivity.this,"0");
        } else {
            SharedPrefrences.set_trackCheck(ShippingSpecificationActivity.this,"1");
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (trackCheck.isChecked()) {
                    ...
                    if(trackbtnpress){
                        trackCheck.setChecked(true);
                        SharedPrefrences.set_trackCheck(ShippingSpecificationActivity.this,"1");
                        U.beepError(ShippingSpecificationActivity.this, null);
                        CommonDialogs.customToast(ShippingSpecificationActivity.this, "Please delete the location digits");
                    } else {
                        SharedPrefrences.set_trackCheck(ShippingSpecificationActivity.this,"0");
                        setProc(PROC_BOXNO);
                    }
    ...
    @OnClick(R.id.boxSelect) void boxSelect(){

        boxBottom = new BottomSheetDialog(this);
        boxBottom.setContentView(R.layout.box_button_layout                                                                                                                                                                                                       );
        boxBottom.heightParam(ViewGroup.LayoutParams.MATCH_PARENT);
        boxBottom.cancelable(false);
        boxBottom.setCanceledOnTouchOutside(false);
        rvNumbers = (RecyclerView) boxBottom.findViewById(R.id.rvNumbers);
        ImageView menu_drawer= (ImageView)boxBottom.findViewById(R.id.menu_drawer);
        ...
        adapter = new BoxSelectAdapter(this, arrBox, itemClickListener);
    ...
    private void setSpinner() {
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_item,sizes){
            ...
            public View getDropDownView(int position, View convertView, ViewGroup parent) {
                ...
                if (position == 0&& !getBoxsizeChange()) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                if (position!=0) {
                    Log.e("ShippingSpecification","Size1  "+position);
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                U.beepError(ShippingSpecificationActivity.this,"サイズを選択");
    ...
    public void SizeSelect(View view) {
        if(!getBoxSize().equalsIgnoreCase("") && getBoxsizeChange()) {
            SweetAlertDialog dialog =new SweetAlertDialog(this);
            dialog.setTitle("デフォルトサイズが\n" +
                    "設定されていますが\n" +
                    "変更しますか？\n");
            dialog.setConfirmButton("はい", new SweetAlertDialog.OnSweetClickListener() {
                @Override
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    SelectButtonSize(view);
                    dialog.dismiss();
                }
            });
            dialog.setCancelButton("いいえ", new SweetAlertDialog.OnSweetClickListener() {
                @Override
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    dialog.dismiss();
                }
    ...
    void SelectButtonSize(View view) {
        switch(view.getId()){
            case R.id.btn_sixty:
                btnpress=true;
                size="60";
...
//                editor.putString("trackDigits",track);
                ...
                editor.putString("LocationDigits","0");
                _sts(R.id.trackFixDigits,"");
                SharedPrefrences.set_trackdigit(this,"");
            }
            editor.commit();
        }
    }
    ...
    public void inputedEvent(String buff,boolean isScaned) {
        switch (mProcNo) {
            case PROC_TRACKID:	// バーコード
                ...
                Log.e(TAG,"shopidddddd  "+ BaseActivity.getShopId()+"/ " +action +"/ "+company);
                ...
                if (BaseActivity.getBoxSelected() == true ) {
                    if (action.equals("shipping")) {
                        Globals.getterList.add(new ParamsGetter("mode", "trackingno_check"));
                    }
                ...
                new MainAsyncTask(ShippingSpecificationActivity.this, Globals.Webservice.shippingStatus, 1, ShippingSpecificationActivity.this, "Form", Globals.getterList,true).execute();
                break;
                    ...
                    if(!mTarget.get("shipping_company").equals("0")){
                        ...
                        for(String t :tracklist){
                            ...
                            if(t.equals(buff)){
                                ...
                                mRequestStatus = REQ_TRACK_CHECK;
                        ...
                        if(!match){
                            ...
                            U.beepError(this, "検品を行った注文と問い合わせ番号が異なります。");
                            _gt(R.id.quantity).setFocusableInTouchMode(true);
                        }
...
//        2023-07-14
    ...
    public void scheduleDate (String date)
    {
        int days =0;
        try {
            String date1 = reverseDate(date);
            SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
            Date scheduledate = sdf.parse(date1);
            Log.e(TAG, "expirationdateeeeeee     " + scheduledate);
            ...
            Date curr = sdf.parse(formattedDate);
            days = U.getDaysDifference(curr, scheduledate);
        }
        catch (Exception e){
    ...
    void showdialog(){
        ...
        dialog.setTitle("出荷予定日が先日付ですが、確定しますか？");
    ...
    public void onPostSuccess(Object result, int flag, boolean isSucess) {
        ...
        try {
            ...
            if ("0".equals(code) )
            {
                ...
                {
                    if (SlipPrinterScreen.equalsIgnoreCase("SlipPrinter")){
                        new CheckSpecificationnew().post(code,msg,result1, mHash, ShippingSpecificationActivity.this);

                    }else{
                        new CheckSpecification().post(code,msg,result1, mHash, ShippingSpecificationActivity.this);

                    }
                }
                else if(mRequestStatus == REQ_TRACK_CHECK){
                    String flag1="";
                    for (int i = 0; i < result1.size(); i++) {
                        JsonHash row = (JsonHash) result1.get(i);

                        if (row.containsKey("shipped_flag")) {
                            flag1 = row.getStringOrNull("shipped_flag");
                        }
                    }
                    ...
                    if(flag1.equals("1")){
                        ...
                        if (Integer.parseInt(mTarget.get("processedCnt")) <= Integer.parseInt(mTarget.get("quantity"))) {
                            ...
                            else{// to move back to box no in multi tacking no. case
                                if(getBoxSize().equals(""))
                                    setProc(PROC_BOXNO);
                            }
                        }
                    ...
                    if (BaseActivity.getBoxSelected() == true ){
                        ...
                        else  new GetSpecification().post(code,msg,result1, mHash, ShippingSpecificationActivity.this);
                ...
                new android.app.AlertDialog.Builder(this, R.style.DialogThemee)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in = new Intent(ShippingSpecificationActivity.this, LoginActivity.class);
                ...
                {
                    new CheckSpecificationnew().valid(code,msg,result1, mHash, ShippingSpecificationActivity.this);
                }
                else if(mRequestStatus == REQ_QTY){
                    new GetSpecification().valid(code,msg,result1, mHash, ShippingSpecificationActivity.this);
                }
    ...
    public void onItemClick(int position) {
        ...
        if(!getBoxSize().equalsIgnoreCase("")&& getBoxsizeChange()) {
            ...
            dialog.setConfirmButton("はい", new SweetAlertDialog.OnSweetClickListener() {
                ...
                public void onClick(SweetAlertDialog sweetAlertDialog) {
                    btnpress=true;
                    size=arrBox[position];

                    boxsize.setText(arrBox[position]);
                    if(mProcNo==PROC_BOXNO)
                        inputedEvent(size);
                    boxBottom.dismiss();
                    dialog.dismiss();
