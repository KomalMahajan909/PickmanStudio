...
public class NewBoxSizeActivity extends BaseActivity implements View.OnClickListener, MainAsynListener {
    ...
    @BindView(R.id.boxlayout2)
    LinearLayout layout2;
    @BindView(R.id.boxlayout3)
    ...
    String TAG = NewBoxSizeActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(NewBoxSizeActivity.this);
        ...
        if (BaseActivity.getOrderInfoBy() == SettingActivity.ORDER_NUMBER)
            orderidtxt.setText(R.string.orderNumber);
        else
    ...
    private void setSpinner() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                U.beepError(NewBoxSizeActivity.this, "サイズを選択");
                setBoxSize(sizes.get(0));
            }
        });
    }

    @OnClick(R.id.box_clear)
    void boxClear() {
    ...
    public void inputedEvent(String buff, boolean isScaned) {
        ...
        switch (mProcNo) {
            case PROC_ORDERID:    // バーコード
                ...
                new MainAsyncTask(NewBoxSizeActivity.this, Globals.Webservice.shippingStatus, 1, NewBoxSizeActivity.this, "Form", Globals.getterList, true).execute();
                break;
            ...
            case PROC_BOXNO:
                if (_gts(R.id.edtboxsize).length()>3)
                {
                    U.beepError(this, "桁数は3桁までです。");
                    _gt(R.id.edtboxsize).setFocusableInTouchMode(true);
                    break;
                }else if (BaseActivity.getsizepos() == 0 && btnpress == false && this._gts(R.id.edtboxsize).equals("")) {
...
//			hiddenPanel.startAnimation(bottomDown);
        ...
        new MainAsyncTask(this, Globals.Webservice.shippingStatus, 1, NewBoxSizeActivity.this, "Form", Globals.getterList, true).execute();
        ...
        try {
            ...
            if ("0".equals(code)) {
                ...
                if (mRequestStatus == REQ_INITIAL) {
                    ...
                    new CheckTrack().post(code, msg, result1, mHash, NewBoxSizeActivity.this);
                    ...
                    if (trackreq == true) {
                        ...
                        setProc(NewBoxSizeActivity.PROC_ORDERID);
                ...
                new android.app.AlertDialog.Builder(this, R.style.DialogThemee)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in = new Intent(NewBoxSizeActivity.this, LoginActivity.class);
                ...
                if (mRequestStatus == REQ_INITIAL) {
                    ...
                    new CheckTrack().valid(code, msg, result1, mHash, NewBoxSizeActivity.this);
                } else if (mRequestStatus == REQ_QTY) {
                    U.beepError(this, msg);
                }
            }
