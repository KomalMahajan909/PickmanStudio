...
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.CheckIrisOrder;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.ClearIrisPicking;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.GetIrisOrderDetail;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.GetIrisPickingOrdersList;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.GetIrisPiking;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.IrisFixedPicking;
import com.itechvision.ecrobo.pickman.Chatman.IrisScreens.Api.ListOrdersIrisCount;
...
public class IrisPickingActivity extends BaseActivity implements View.OnClickListener, MainAsynListener {
    ...
    @BindView(id.gridcase) LinearLayout layoutcase;
    ...
    String serialno = "";
    private boolean fromqty= false,lotformqty = false;
    ...
    private  boolean visible = false,  is_scan = false;
    ...
    public static final int REQ_ALLORDERS_DETAIL = 9;

    public static boolean skipvalue=false;

    String TAG= IrisPickingActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (orderRequestSettings == SettingActivity.ORDER_ID) {
            setContentView(R.layout.activity_iris_picking);
        }
        else if (orderRequestSettings == SettingActivity.ORDER_NUMBER) {
            setContentView(R.layout.activity_iris_picking_order_no);
        }
        else if (orderRequestSettings == SettingActivity.ORDER_TRACKING_NO) {
            setContentView(R.layout.activity_iris_picking_tracking_no);
        }

        ButterKnife.bind(IrisPickingActivity.this);
        ...
        dialog = new Dialog(IrisPickingActivity.this);
        ...
        if(BaseActivity.get_CaseQtyCheckPicking()){
        ...
        _gt(id.caseqnt).setBackground(getResources().getDrawable(drawable.basic_edittext_off_nopadding));
        ...
        checkCaseQty.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(checkCaseQty.isChecked()){
                    BaseActivity.set_CaseQtyCheckPicking(true);
                    layoutcase.setVisibility(View.VISIBLE);
                }
                else{
                    BaseActivity.set_CaseQtyCheckPicking(false);
                    layoutcase.setVisibility(View.GONE);
                }
            }
        });
    ...
    private void getIDs() {
        ...
        actionbarImplement(this, "ケースピック検品", " ",
                0, true,false,true );
        //menubarr
...
//        imgRight.setOnClickListener(this);
    ...
    @OnClick (id.lineNoBtn) void lineNoBtn (){
        ...
        if(mProcNo == PROC_LINE_NO) {
            ...
            if (!reqOrderId.equals("")) {
                ...
                U.beepError(IrisPickingActivity.this, "注文IDは必須です");
                setProc(startProc);
            }
        }
    }
    ...
    public void getOrders(){
        ...
        new MainAsyncTask(this, Globals.Webservice. getIrisShipping, 1, IrisPickingActivity.this, "Form", Globals.getterList, true).execute();
    }
    ...
    protected boolean showPopup2() {
        ...
        new MainAsyncTask(this, Globals.Webservice.getPickingOrderDetail, 1, IrisPickingActivity.this, "Form", Globals.getterList,true).execute();
        ...
        switch (mProcNo) {
            case PROC_ORDER_NO:	// 注文No
                ...
                if (orderRequestSettings == SettingActivity.ORDER_NUMBER) {
                    ...
                    new MainAsyncTask(this, Globals.Webservice.checkIrisOrder, 1, IrisPickingActivity.this, "Form", Globals.getterList,true).execute();
                }
                    ...
                    if(lotpressed ==false){
                        ...
                        if ((cProductList.get("barcode").trim().equals(barcode))|| cProductList.get("code").trim().equals(barcode) || barcodematch){
                            ...
                            if(serialPresent.equals("0")) {
                                if(checkCaseQty.isChecked()) {
                                    String case_count = cProductList.get("case_count");
                                    cProductList.put("case_count", U.plusTo(case_count, "1"));

                                    String temp = U.MultiplyTo(cProductList.get("case_count"),cProductList.get("case_qty"));
            ...
            case PROC_LOT_NO:
                ...
                if(((buff.equals(GetIrisPiking.getlot))||(buff.equals(IrisFixedPicking.fixlot)))&& (cProductList.get("lot").equals(lot)))
                {
            ...
            case PROC_QTY:
                ...
                if (isScaned) {
                    ...
                    if(!cProductList.get("lot").equals("")){
                        ...
                        if (buff.equals(barcode) || buff.equals(cProductList.get("lot"))) {
                            if (buff.equals(barcode) && !lotn.equals("")) { /*if barcode2 is not empty then store barcode1 and wait till second barcode*/
                                setBarcodeTemp(buff);
                                fromqty =true;

                                setProc(PROC_LOT_NO);/*store barcode1 in static variable*/
                                break;
                            }
...
//                                            U.beepError(this, "Scanned barcode and serialno. not matched");
                            ...
                            if ( ((getBarcodeTemp().concat(buff)).equals(bar.concat(lotn)))||((getBarcodeTemp().concat(buff)).equals(selectedbarcode.concat(lotn))) ) {
                                setBarcodeTemp("");
...
//                        cProductList.put("processedCnt", U.plusTo(processedCnt, qtyUpdate));
            ...
            case PROC_SERIAL_NO:
                ...
                if(_gts(id.serialno).equals("")){
                    U.beepError(IrisPickingActivity.this,null);
                    break;
                }
                if(_gts(id.serialno).equals(barcode1)){
                    ...
                    if (fromqty == false) {
                        ...
                        if(checkCaseQty.isChecked()) {
                            ...
                            mTextToSpeak.startSpeaking(_gts(id.quantity));
                            fromqty = false;
                            if (Integer.parseInt(_gts(id.quantity)) > 1)
                                mTextToSpeak.startSpeaking(_gts(id.quantity));
                        }
                        else{
...
//                Log.e(TAG, "DataAssigned");
    ...
    public void GetRow(){
        ...
        new MainAsyncTask(this, Globals.Webservice.getIrisPiking, 1, IrisPickingActivity.this, "Form", Globals.getterList,true).execute();
    }
...
//                    }
                    ...
                    .setPositiveButton("はい", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if(!"".equals(_gts(id.shortBarcode)))
                                ...
                                IrisPickingActivity.this.nextProcess();
                            }
    ...
    protected void onRestart() {
        ...
        if (BaseActivity.getOrderInfoBy() == orderRequestSettings ) {
            ...
            this.finish();
            Intent i = new Intent(this, IrisPickingActivity.class);
            startActivity(i);
        }
    }
    ...
    private void fixedRequest(Integer status) {
        ...
        if (status == CLEAR_INSPECT ) {
            ...
            new MainAsyncTask(this, Globals.Webservice.fixedIrisPiking, 1, IrisPickingActivity.this, "Form", Globals.getterList,true).execute();
...
//            if (orderRequestSettings == SettingActivity.ORDER_ID) {
    ...
    public void skipEvent() {
        ...
        new AlertDialog.Builder(IrisPickingActivity.this)
...
//                this._sts(id.trackingNumber, "");
    ...
    public void onPostSuccess(Object result, int flag, boolean isSucess) {
        ...
        GetIrisPiking.getbarcode ="0";
        GetIrisPiking.getlot ="0";
        ...
        try {
            ...
            if ("0".equals(code) == true)
            {
                ...
                {
                    new ListOrdersIrisCount().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERID)
                {
                    new CheckIrisOrder().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERID1)
                {
                    new GetIrisPiking().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                ...
                {
                    new ClearIrisPicking().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERDETAIL){
                    new GetIrisOrderDetail().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }

                else if(mRequestStatus ==FIXED_REQ)
                {
                    new IrisFixedPicking().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ALLORDERS_DETAIL)
                {
                    new GetIrisPickingOrdersList().post(code,msg,result1, mHash, IrisPickingActivity.this);
                }
            ...
            else if(code.equalsIgnoreCase("1020"))
            {
                new AlertDialog.Builder(this, R.style.DialogThemee)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in = new Intent(IrisPickingActivity.this,LoginActivity.class);
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("する", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                new MainAsyncTask(IrisPickingActivity.this, Globals.Webservice.getIrisPiking, 1, IrisPickingActivity.this, "Form", Globals.getterList,true).execute();
                            }
                        })
                ...
                if(mRequestStatus == REQ_INITIAL)
                {
                    new ListOrdersIrisCount().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERID)
                {
                    new GetIrisPiking().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if (mRequestStatus == REQ_LINENO)
                {
                    new GetIrisPiking().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                ...
                {
                    new ClearIrisPicking().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERDETAIL)
                {
                    new GetIrisOrderDetail().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus ==FIXED_REQ)
                {
                    new IrisFixedPicking().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ALLORDERS_DETAIL)
                {
                    new GetIrisPickingOrdersList().valid(code,msg,result1, mHash, IrisPickingActivity.this);
                }
                else if(mRequestStatus == REQ_ORDERID1)
                {
                    new GetIrisPiking().valid(code,msg,result1, mHash, IrisPickingActivity.this);
