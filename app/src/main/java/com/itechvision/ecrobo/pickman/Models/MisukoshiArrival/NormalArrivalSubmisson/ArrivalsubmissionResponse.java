...
public class ArrivalsubmissionResponse {
    ...
    public ArrivalsubmissionResponse(String code, String message, ArrayList<Arrival_ID_list_data> results, String pending_orders, String pending_arrivals) {
        this.code = code;
