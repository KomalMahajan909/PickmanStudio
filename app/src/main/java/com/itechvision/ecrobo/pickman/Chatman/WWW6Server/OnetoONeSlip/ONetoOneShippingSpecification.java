...
import com.itechvision.ecrobo.pickman.Chatman.WWW6Server.OnetoONeSlip.ShippingSpecificatioONetoOne.CheckSpecificationOne;
import com.itechvision.ecrobo.pickman.Chatman.WWW6Server.OnetoONeSlip.ShippingSpecificatioONetoOne.CheckSpecificationnewONE;
import com.itechvision.ecrobo.pickman.Chatman.WWW6Server.OnetoONeSlip.ShippingSpecificatioONetoOne.DaimaruGetSpecificationOne;
...
public class ONetoOneShippingSpecification extends BaseActivity implements View.OnClickListener, MainAsynListener {
    ...
    String orderId = "", action = "",company ="",SlipPrinterScreen="",date = "";
    String TAG= ONetoOneShippingSpecification.class.getSimpleName();
   ...
   // microsoft
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ButterKnife.bind(ONetoOneShippingSpecification.this);
        ...
        if(intent.hasExtra("action")){
            ...
            date = intent.getStringExtra("shipping_date");
            Log.e(TAG,TAG+company+"!1111111");

            Log.e(TAG,date+"!2222222");
        }
        ...
        if(trackfix.equals("0") ||trackfix.equals("") ){
            ...
            SharedPrefrences.set_trackCheck(ONetoOneShippingSpecification.this,"0");

        } else {
            SharedPrefrences.set_trackCheck(ONetoOneShippingSpecification.this,"1");
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (trackCheck.isChecked()) {
                    ...
                    if(trackbtnpress){
                        trackCheck.setChecked(true);
                        SharedPrefrences.set_trackCheck(ONetoOneShippingSpecification.this,"1");
                        U.beepError(ONetoOneShippingSpecification.this, null);
                        CommonDialogs.customToast(ONetoOneShippingSpecification.this, "Please delete the location digits");
                    } else {
                        SharedPrefrences.set_trackCheck(ONetoOneShippingSpecification.this,"0");
                        setProc(PROC_BOXNO);
                    }
    ...
    private void setSpinner() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                U.beepError(ONetoOneShippingSpecification.this,"サイズを選択");
    ...
    public void inputedEvent(String buff,boolean isScaned) {
        ...
        switch (mProcNo) {
            case PROC_TRACKID:	// バーコード
                ...
                new MainAsyncTask(ONetoOneShippingSpecification.this, Globals.Webservice.shippingStatus, 1, ONetoOneShippingSpecification.this, "Form", Globals.getterList,true).execute();
                break;
    ...
    public void onPostSuccess(Object result, int flag, boolean isSucess) {
        ...
        try {
            ...
            if ("0".equals(code) )
            {
                ...
                {
                    new DaimaruGetSpecificationOne().post(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                }
                else if(mRequestStatus == REQ_TRACKING)
                {
                    if (SlipPrinterScreen.equalsIgnoreCase("SlipPrinter")){
                        new CheckSpecificationnewONE().post(code,msg,result1, mHash, ONetoOneShippingSpecification.this);

                    }else{
                        new CheckSpecificationOne().post(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                    ...
                    if (BaseActivity.getBoxSelected() == true ){
                        if(action.equals("shipping")){
                            ...
                            if (SlipPrinterScreen.equalsIgnoreCase("SlipPrinter")){
                                if (BatchStatus.equalsIgnoreCase("2")){
                                    Intent intent=new Intent(this,One_to_One_SlipPrinter.class);
                                    startActivity(intent);
                                    finish();
                                }else{
                                    Intent intent=new Intent(this,One_to_One_SlipPrinter.class);
                                    intent.putExtra("action","back");
                                    intent.putExtra("shipping_date",date);
                                    startActivity(intent);
                                    finish();
                                }
                            }else{
                        ...
                        else  new DaimaruGetSpecificationOne().post(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                ...
                new android.app.AlertDialog.Builder(this, R.style.DialogThemee)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in = new Intent(ONetoOneShippingSpecification.this,LoginActivity.class);
                ...
                if(mRequestStatus == REQ_INITIAL) {
                    new DaimaruGetSpecificationOne().valid(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                }
                else if(mRequestStatus == REQ_TRACKING)
                {
                    new CheckSpecificationnewONE().valid(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                }
                else if(mRequestStatus == REQ_QTY){
                    new DaimaruGetSpecificationOne().valid(code,msg,result1, mHash, ONetoOneShippingSpecification.this);
                }
