...
/**
 * Created by lenovo on 8/29/2019.
 */

public class CheckTrack{
    String TAG = "CheckTrack";
...
//        U.beepKakutei(activity, "検品データを登録しました。");
        NewBoxSizeActivity act = ((NewBoxSizeActivity) activity);
        ...
        box_size = row.getStringOrNull("boxsize");
...
public void onClick(View v) {
    ...
    public void valid(String code, String message, JsonArray list, HashMap<String, String> params, Activity activity) {
        ...
        ((NewBoxSizeActivity) activity).setProc(NewBoxSizeActivity.PROC_TRACKID);
        }
