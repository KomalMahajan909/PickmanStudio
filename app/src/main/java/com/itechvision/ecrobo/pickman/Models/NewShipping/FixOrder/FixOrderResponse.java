package com.itechvision.ecrobo.pickman.Models.NewShipping.FixOrder;
...
public class FixOrderResponse {
    ...
    public FixOrderResponse(String code, String message, String all_order_count, String not_inspection_row_count, ArrayList<Map<String, String>> data, String shortage_row_count) {
        this.code = code;
        this.message = message;
        this.all_order_count = all_order_count;
        this.not_inspection_row_count = not_inspection_row_count;
