...
public class GetArrivalOrderResponse {
    @SerializedName("code")
    private  String code;
    ...
    public GetArrivalOrderResponse(String code, String message, ArrayList<Arrival_ID_list_data> results, String pending_orders, String pending_arrivals) {
        this.code = code;
