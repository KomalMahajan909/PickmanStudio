...
import com.itechvision.ecrobo.pickman.Chatman.Ship.api.GetBatchPikingList;
...
public class BatchPickingOrder extends BaseActivity implements View.OnClickListener, MainAsynListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_batch_picking_order);
        ButterKnife.bind(BatchPickingOrder.this);
...
//            mRequestStatus = REQ_BARCODE;
        new MainAsyncTask(this, Globals.Webservice.BatchPicking, 1, BatchPickingOrder.this, "Form", Globals.getterList, true).execute();
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent i = new Intent(BatchPickingOrder.this, BatchPickingActivity.class);
        ...
        try {
            ...
            if ("0".equals(code) == true) {
                ...
                Log.e("SendLogs111",code+"  "+msg+"  "+result1);
                    ...
                    new GetBatchPikingList().post(code,msg,result1, mHash,BatchPickingOrder.this);
                ...
                new android.app.AlertDialog.Builder(this, R.style.DialogThemee)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Intent in = new Intent(BatchPickingOrder.this,LoginActivity.class);
                    ...
                    new GetBatchPikingList().valid(code, msg, result1, mHash, BatchPickingOrder.this);
            }}
        catch (Exception e)
        {
            System.out.print(e);
