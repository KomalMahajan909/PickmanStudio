...
public class GetNewArrivalAllocation {
    ...
    public void post(String code, String message, JsonArray list,
        ...
        DirectarrivalActivity act = (DirectarrivalActivity) activity;
        long qty = 0;
        String productCode = "";
        String barcode = "";
        ...
        if(GetArrivalNew.arrivalList>0){
...
//                    if (row.getStringOrNull("location") != null && row.getStringOrNull("location").equals("") == false) {
                    ...
                    if(!location.equals("z") && !location.equals("y")&& row.containsKey("fixed_location"))
                        DirectarrivalActivity.location_fixed = row.getStringOrNull("fixed_location");
