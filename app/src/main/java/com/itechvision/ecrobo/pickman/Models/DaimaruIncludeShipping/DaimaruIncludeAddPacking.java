...
public class DaimaruIncludeAddPacking {
    String TAG = "IncludeAddPacking";
    ...
    void setDialog(Activity activity){
        ...
        txt.setText("作成されたボックス番号は"+Daimaru_Shipping.mBoxNo+"です");
