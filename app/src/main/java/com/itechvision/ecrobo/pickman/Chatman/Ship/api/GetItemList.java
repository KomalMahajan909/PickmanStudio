...
public class GetItemList
{
    ...
    public void post(String code, String message, JsonArray list,
        ...
        row1 = row.getJsonArrayOrNull("batch_items");
        arrayList.add("選択する");
        ...
        if(arrayList.size()>1){
            ...
            Spinner spinner = (Spinner) activity.findViewById(R.id.ItemSpinner);
            spinner.setAdapter(adapter);
            act.setProc(TruckBatchActivity.PROC_ITEM);
            if(arrayList.size() == 2){
