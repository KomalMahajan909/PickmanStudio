...
public class DaimaruGetSpecification {
    ...
    public void post(String code, String message, JsonArray list, HashMap<String, String> params, Activity activity) {
        ...
        if (act.trackreq == true) {
            ...
            if (act._gts(R.id.edtboxsize).equals(""))
                act.setProc(DaimaruShippingSpecificationActivity.PROC_BOXNO);
            else
                act.setProc(DaimaruShippingSpecificationActivity.PROC_TRACKID);
